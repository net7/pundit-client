import approxSearch, { Match as StringMatch } from 'approx-string-match';
 ...
 * @return {StringMatch[]}
 */
export function search(text: string, str: string, maxErrors: number): StringMatch[] {
 ...
 * @param {string} str
 */
export function textMatchScore(text: string, str: string): number {
