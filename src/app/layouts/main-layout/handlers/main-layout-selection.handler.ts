...
import { getHostDocumentBody } from 'src/app/models/annotation/html-util/getHostDocumentBody';
...
export class MainLayoutSelectionHandler implements LayoutHandler {
  ...
  private hasSelection() {
    return !!(
      ...
      && describe(getHostDocumentBody(), selectionModel.getCurrentRange()).length === 3
    );
  }
