...
aws s3 sync --acl public-read  --region='eu-south-1' pundit-icon-font s3://static-pundit/pundit-icon-font
cd ../..;
aws s3 sync --acl public-read  --region='eu-south-1' dist/embed-prod s3://static-pundit/releases/
rm -fr dist/fonts
